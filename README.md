# Calculator
Моя первая программа на Java, после очень долгого перерыва в программировании и знакомства с java 3 дня.

Это было ТЗ для поступления на куры Java-Mentor. Работу приняли.
